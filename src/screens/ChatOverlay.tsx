    ...
    >
      <SafeAreaView className="flex-1 bg-dawn">
        <View className="flex-row items-center justify-end px-5 py-2">
          ...
          >
            <Text
              style={{ color: "#d81a1a", fontWeight: "bold", fontSize: 20 }}
            >
              {"\u2715"}
            </Text>
          </Pressable>
                ...
                <View className="px-5 flex-row flex-wrap gap-2">
                  {groupCmds.map((cmd, i) => (
                    <Pressable
                      ...
                      style={{
                        backgroundColor: colors.stream + "18",
                        borderWidth: 1,
                        borderColor: colors.stream + "30",
                      }}
                    >
                      <Text className="font-inter text-sm text-stream">
                        {commandLabel(cmd)}
                      </Text>
                    </Pressable>
                  ))}
